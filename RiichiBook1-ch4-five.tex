...
With the draw of {\LARGE\suo{4}}, we now have a 3-way side-wait block in {\jap souzu} (bamboos). {\LARGE\suo{3}} or {\LARGE\suo{7}} could be our back-up candidate for the head, in case we draw another {\LARGE\wan{6}}. Since there is {\jap sanshoku} (Mixed Triple Chow) of 345, we discard {\LARGE\suo{3}}. 
\end{itembox}
